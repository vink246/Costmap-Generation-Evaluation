...
\author{\normalfont Rut Santana \and Ibrahim Alshayeb \and Vineet Kulkarni \and Meera Ranjan}
...
\begin{table}[h]
  ...
  \begin{tabular}{lcccccc}
    ...
    ViT & 0.1890 & 0.4940 & 0.5990 & \textbf{0.7230} & 0.6500 & 10.8 \\
...
\subsection{Implementation Notes}
	...
	\textbf{ViT.} Custom Vision Transformer with patch embedding (\(16\times16\)), stacked transformer encoder, and a residual convolutional decoder with skip connections for 1-channel output reconstruction. Same Adam optimizer and composite loss (BCE, Dice, Boundary) used to balance pixel accuracy, region overlap, and edge sharpness. ViT excelled on NYU (MAE 0.0063, IoU 0.975, F1 0.987) and achieved the highest recall on KITTI (0.723), indicating stronger sensitivity to thin/fragmented obstacles but with some over-segmentation (lower precision). Profiled model: \textbf{10.81M} params, \textbf{5.84 GFLOPs}, \textbf{6.61 ms/frame} on Tesla V100-PCIE-16GB (\textasciitilde151 FPS).\par
