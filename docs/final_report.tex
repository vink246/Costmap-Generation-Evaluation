...
\begin{figure}[h]
  \centering
  % NYU appendix qualitative (binarized and difference views)
  \includegraphics[width=0.95\linewidth]{figures/bin_nyu_nyu_val_pred_000000.png}\\
  \includegraphics[width=0.95\linewidth]{figures/diff_nyu_nyu_val_pred_000000.png}\\
  \includegraphics[width=0.95\linewidth]{figures/bin_nyu_nyu_val_unet_rgb_000000.png}
  \caption{NYU appendix panels. Top: binarized RGBD prediction vs. label; middle: difference heatmap (prediction-label); bottom: binarized RGB-only example. These illustrate high fidelity for RGBD and mid-cost flattening for RGB-only that reduces planner success.}
\end{figure}

\begin{figure}[h]
  \centering
  % KITTI appendix qualitative (post-fix, binarized and difference views)
  \includegraphics[width=0.95\linewidth]{figures/bin_kitti_kitti_val_unet_rgbd_retrain_full_000000.png}\\
  \includegraphics[width=0.95\linewidth]{figures/diff_kitti_kitti_val_unet_rgbd_retrain_full_000000.png}\\
  \includegraphics[width=0.95\linewidth]{figures/bin_kitti_kitti_val_unet_rgbd_retrain_full_000004.png}
